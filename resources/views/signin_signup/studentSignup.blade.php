			...
			<div class="row">		
				...
				<div class="col-xs-12 col-sm-12 col-md-12">
					<div class="our-course">
						...
						<form name="ajax-form" id="contact-form2" action="{{route("studentSignup")}}" method="post" class="contact-form">
							{{csrf_field()}}
							...
							<div class="col-sm-12 col-md-12 author">
								<input id="name" name="sName"  placeholder="studentname" type="text">
							</div>
							<div class="col-sm-12 col-md-12 email">
								<input id="email" name="sEmail"  placeholder="Email" type="text">
							</div>
							<div class="col-sm-12 col-md-12 password">
								<input id="suject" name="sPassword" placeholder="password" type="password">
							</div>
							<div class="col-sm-12 col-md-12 password">
								<input id="suject" name="cPassword" placeholder="Confirm password" type="password">
							</div>
